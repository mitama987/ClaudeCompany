...
- カード1：「無料版」¥0 ／ 1アカウントだけ試せる
- カード2：「買い切り＋アドオン1つ」¥2,980〜 ／ 複数アカウント対応 ／ AIクレジット1,000pt
- カード3：「フル買切り」¥19,800 ／ 全5アドオン同梱（単品計¥23,000相当から¥3,200割引）

下部に帯：「サブスクなし・全プラン買い切り・月額費用ゼロ」

スタイル：SaaS風 Pricing Cards。**3つのカードは完全に対等・並列で表示し、特定のカードを「おすすめ」「人気」「ベスト」などのバッジやハイライトで強調しない**。3カードのサイズ・影・枠線・色の濃さは統一する。色は3カードで穏やかに区別する程度（例：薄いグレー・薄い青・薄い金）でOKだが、突出して目立つカードは作らない。フラットデザインで清潔感のあるインフォグラフィック。テキストは全て日本語。""",
    },
    {
