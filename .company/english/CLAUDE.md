...
2. **英訳**: 秘書が `scripts/NN-xxx.en.md` を生成
3. **音声化**: `uv run python scripts/english_tts/gen_audio.py --topic NN`
4. **練習ログ**: 任意で `routine/YYYY-MM-DD.md` に記録
